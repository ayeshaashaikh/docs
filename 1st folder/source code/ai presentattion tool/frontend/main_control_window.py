...
from backend.subtitles import (start_ultra_fast_subtitles,
...
def toggle_subtitles():
    ...
    if subtitles_active[0]:
        from backend.subtitles import stop_ultra_fast_subtitles
        stop_ultra_fast_subtitles()
        ...
        from backend.subtitles import start_ultra_fast_subtitles
        start_ultra_fast_subtitles(main_control_window)
